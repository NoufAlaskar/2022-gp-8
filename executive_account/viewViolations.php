...
<h3>البلاغات على السياسات</h3>
<?php
	// get all violation for all policies that sent by employee
     $query1 = "SELECT * FROM violation Order BY v_status ";
	...
	if($count == 0) {
		...
		// print all data returned into table
?>
<p></p>
