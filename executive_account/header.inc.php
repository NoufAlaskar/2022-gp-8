...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>حساب الرئيس التنفيذي - <?php echo $fullname ?></title>
...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="index.php"><i class="fa fa-dashboard"></i> حساب الرئيس التنفيذي - <?php echo $fullname ?></a>
    </div>
    <div>
