...
if(isset($_POST['SendBtn']))
{
	...
	if($run){
		...
		echo "<p>Your Policy Updated Successfully.</p>";
		echo '</div>';
...
?> 				
  			<div class="panel panel-danger">
				<div class="panel-heading"><h3 align="center">Update Policy</h3></div>
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<input type="text" id="subject" class="form-control" autofocus name="subject" placeholder="Policy Title" required value="<?php echo $row1['title'] ?>">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<textarea id="content" class="form-control"  name="content" placeholder="Policy Description" required rows="6"><?php echo $row1['description'] ?></textarea>
							</div>
						</div>
					</div>
				</div>
				<div class="panel-footer">
					<a href="PolicyDetails.php?policy_id=<?php echo $policy_id ?>" class="btn btn-sm btn-warning">Back </a> 
					<input type="submit" class="btn btn-sm btn-danger pull-right" name="SendBtn" value="Update Policy" >
				</div>
			</div>
 <?php	
		}
