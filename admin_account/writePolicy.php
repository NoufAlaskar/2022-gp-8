...
if(isset($_POST['SendBtn']))
{
	...
	$sql="INSERT INTO policy VALUES (NULL, '$subject', '$content', NOW(), $admin_id,$group_id,0,0,NULL,0,NULL,0,0,NULL,0)";
  			...
  			<div class="panel panel-danger">
				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<input type="text" id="subject" class="form-control" autofocus name="subject" placeholder="عنوان السياسة" required  oninput="this.setCustomValidity('')"  oninvalid="this.setCustomValidity('نسيت ادخال عنوان السياسة')">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
									...
									<textarea id="content" class="form-control"  name="content" placeholder="وصف السياسة" required rows="6"  oninput="this.setCustomValidity('')"  oninvalid="this.setCustomValidity('نسيت ادخال وصف السياسة')"></textarea>
