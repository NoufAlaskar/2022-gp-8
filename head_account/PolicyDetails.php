  		...
  		<div class="col-md-7"  style="margin-top: 30px;">
			...
			?>	
                ...
                <?php if($row1['sendToExec'] == 0) { ?>
                    <a href="sendToExe.php?policy_id=<?php echo $row1['policy_id'] ?>" class="btn btn-sm btn-primary pull-right">ارسال الى الرئيس التنفيذي</a>  
                <?php } else { ?>
                    <span class="label label-info pull-right"><i class="fa fa-check"></i> تم الارسال الى الرئيس التنفيذي</span>
                <?php } ?>
				<br>
			</div>
